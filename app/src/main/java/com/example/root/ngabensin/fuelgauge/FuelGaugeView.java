package com.example.root.ngabensin.fuelgauge;
...
public class FuelGaugeView extends View {
    ...
    public FuelGaugeView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNeedleColor = attributes.getColor(R.styleable.FuelGaugeView_needleColor, Color.parseColor("#e74c3c"));
        mTextColor = attributes.getColor(R.styleable.FuelGaugeView_textColor, Color.BLACK);
        mLineColor = attributes.getColor(R.styleable.FuelGaugeView_lineColorA, Color.BLACK);
