...
public class SignUpActivity$$ViewInjector<T extends com.example.root.ngabensin.SignUpActivity> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131755263, "field '_nameText'");
    target._nameText = finder.castView(view, 2131755263, "field '_nameText'");
    ...
    view = finder.findRequiredView(source, 2131755264, "field '_signupButton'");
    target._signupButton = finder.castView(view, 2131755264, "field '_signupButton'");
    view = finder.findRequiredView(source, 2131755265, "field '_loginLink'");
    target._loginLink = finder.castView(view, 2131755265, "field '_loginLink'");
  }
